...
const EASYPOST_MAX_INVENTORIES_PRODUCT_IDS =
  process.env.EASYPOST_MAX_INVENTORIES_PRODUCT_IDS || 28
...
export const getInventories = async productIds => {
  const chunkedProductIds = chunk(
    productIds,
    EASYPOST_MAX_INVENTORIES_PRODUCT_IDS
  )
